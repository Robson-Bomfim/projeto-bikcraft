...
!(function(e) {
  ...
  var i = -1,
    t = {
      ...
      state: function() {
        return (
          t._doc.visibilityState || t._doc.webkitVisibilityState || "visible"
        );
      },
      ...
      _listen: function() {
        if (!t._init) {
          ...
          t._doc.addEventListener
            ? t._doc.addEventListener(e, i)
            : t._doc.attachEvent(e, i),
            (t._init = !0);
        }
      }
    };
  ...
  (function(e) {
    ...
    var i = -1,
      t = function(t) {
        return (
          (t.every = function(e, n, r) {
            t._time(), r || ((r = n), (n = null)), (i += 1);
            var d = i;
            return (
              (t._timers[d] = { visible: e, hidden: n, callback: r }),
              t._run(d, !1),
    ...
    "undefined" != typeof module && module.exports
      ? (module.exports = t(require("./visibility.core")))
      : t(e.Visibility);
  })(window);
